...
public class ConvertirTemperatura {
	...
	public void CelsiusAFahrenheit(double valorRecibido) {
		...
		celsiusEnFahrenheit = Math.round(celsiusEnFahrenheit*100d)/100d;
	...
	public void CelsiusAKelvin(double valorRecibido) {
		...
		celsiusEnKelvin = Math.round(celsiusEnKelvin*100d)/100d;
		JOptionPane.showMessageDialog(null, valorRecibido + 
				" °C es igual a  "
				+ celsiusEnKelvin + " °K");
	}
	...
	public void FahrenheitACelsius(double valorRecibido) {
		...
		System.out.println((valorRecibido - 32) * 5/9);
	
		FahrenheitEnCelsius = Math.round(FahrenheitEnCelsius*100d)/100d;
		JOptionPane.showMessageDialog(null, valorRecibido + 
				" °F es igual a  "
	...
	public void FahrenheitAKelvin(double valorRecibido) {
		...
		FahrenheitEnKelvin = Math.round(FahrenheitEnKelvin*100d)/100d;
		JOptionPane.showMessageDialog(null, valorRecibido + 
				" °F es igual a  "
	...
	public void KelvinACelsius(double valorRecibido) {
		...
		KelvinEnCelsius = Math.round(KelvinEnCelsius*100d)/100d;
		JOptionPane.showMessageDialog(null, valorRecibido + 
				" °K es igual a  "
				+ KelvinEnCelsius + " °C");
	}
	...
	public void KelvinAFahrenheit(double valorRecibido) {
		...
		KelvinEnFahrenheit = Math.round(KelvinEnFahrenheit*100d)/100d;
		JOptionPane.showMessageDialog(null, valorRecibido + 
				" °K es igual a  "
